...
public class ProductColorRegiserFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ProductColorRegiserFrame frame = new ProductColorRegiserFrame();
	 ...
	 * Create the frame.
	 */
	public ProductColorRegiserFrame() {
		...
		registerSubmitButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				JOptionPane.showMessageDialog(contentPane, "색상등록 중 오류 발생하였습니다.", "등록오류", JOptionPane.ERROR_MESSAGE);
				return;
			}
		...
		registerSubmitButton.setBounds(12, 130, 410, 55);
